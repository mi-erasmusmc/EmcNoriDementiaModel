...
OhdsiRTools::checkUsagePackage("EmcNoriDementiaModel")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/EmcNoriDementiaModel.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EmcNoriDementiaModel.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "EmcNoriDementiaModel")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("EmcNoriDementiaModel")
