...
Vignette: [Using the package skeleton for validating exisitng prediction studies](https://raw.githubusercontent.com/OHDSI/EmcNoriDementiaModel/master/inst/doc/UsingSkeletonPackage.pdf)

Instructions To Prepare Package Outside Atlas
===================
To create the package outside of ATLAS please see [Populating the settings in the package skeleton for validating exisitng prediction studies](https://raw.githubusercontent.com/OHDSI/EmcNoriDementiaModel/master/inst/doc/PopulatingSkeletonPackage.pdf)
...
```r
  ...
  devtools::install_github("ohdsi-studies/EmcNoriDementiaModel")
```
