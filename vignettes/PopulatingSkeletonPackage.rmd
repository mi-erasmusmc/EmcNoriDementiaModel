...
The package is still currently called 'EmcNoriDementiaModel' but you need to rename all the files with the name of your study.  To make this easy I created a function 'replaceName()' that will automatically replace 'EmcNoriDementiaModel' with your new study name. Simply run:
